export function switchPosition(sign, modalrect, popconfirmrect, scroll) {
    let triangle = 8;
    switch (sign) {
        case "TL":
            return {
...
export function switchTrianglePosition(sign, modalrect, popconfirmrect, scroll) {
